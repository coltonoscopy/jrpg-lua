...
function Scrollbar:Create(textureName, height)
    local this = {
        mX = 0,
        mY = 0,
    ...
    local texture = love.graphics.newImage(textureName)
    ...
    this.mSpritesheet = LoadSpritesheet(textureName, texWidth, this.mTileHeight)
    this.mUpSprite:SetQuad(this.mSpritesheet[1])
    this.mCaretSprite:SetQuad(this.mSpritesheet[2])
    this.mBackgroundSprite:SetQuad(this.mSpritesheet[3])
    this.mDownSprite:SetQuad(this.mSpritesheet[4])
...
function Scrollbar:Render()
    self.mUpSprite:Render()
    self.mBackgroundSprite:Render()
    self.mDownSprite:Render()
    self.mCaretSprite:Render()
end
